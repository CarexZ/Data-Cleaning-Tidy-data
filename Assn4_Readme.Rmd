...
Now we have to options: we can create a function for creation of a tidy dataset   
...
```
Or make it part of the script with no function. I have chosen this option, as it is more simple and we use this only once.
